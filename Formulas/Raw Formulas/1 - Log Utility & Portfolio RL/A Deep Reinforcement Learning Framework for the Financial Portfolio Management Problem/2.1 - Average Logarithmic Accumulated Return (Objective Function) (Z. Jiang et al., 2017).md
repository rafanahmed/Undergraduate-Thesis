...
| $r_t$                | Per-period log-return (either the idealised version from [[1.1.2 - Logarithmic Rate of Return (Z. Jiang et al., 2017)]] or the cost-adjusted version from [[2.0 - Log Return with Transaction Costs (Z. Jiang et al., 2017)]], depending on the setting). |
